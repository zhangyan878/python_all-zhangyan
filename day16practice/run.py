...
sender = '2867242015@qq.com'
receivers = ['1246742833@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
mail_host = 'smtp.qq.com'
password = 'vfrhlnskxdisdggg'
tester = '张岩'
# 创建一个带附件的实例
message = MIMEMultipart()
message['From'] = '2867242015@qq.com'
message['To'] = Header("张岩的邮件", 'utf-8')
